...
public class PrinterHelper {
    ...
    public static Student createStudentMenu(Scanner scanner)
        ...
        // Change interpretation of date to be non-lenient
        formatter.setLenient(false);
        // Create and initialise birthDate to null
        Date birthDate = null;
        ...
        while (birthDate == null) {
            try {
                ...
                System.out.println("Invalid date format. Please enter student birth date in mm/dd/yyyy format.");
            }
        }
        System.out.println("|-------------------------------------|");
